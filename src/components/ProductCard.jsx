...
const ProductCard = () => {
  ...
  const handleAddToCart = (product) => {
    ...
    const productWithQty = { ...product, price: numericPrice, qnty: 1 };
        ...
        return (
          <div className="product-card" key={id}>
            <div className="image-container">
              ...
              {isWishlisted ? (
                <FaHeart
                  className="wishlist-icon clicked"
                  onClick={() => handleWishlistToggle({ id, title, price, description, image })}
                />
              ) : (
                <FaRegHeart
            ...
            <div className="product-info">
              ...
              <button
                ...
                onClick={() => handleAddToCart({ id, title, price, description, image })}
              >
                Add to Cart
              </button>
            </div>
